...
import edmt.dev.androidsimsimi.QandR;
...
public class CustomAdapter2 extends BaseAdapter {
    public CustomAdapter2(ArrayList<QandR> list) {
        list_chat_models = list ;
    }
    private List<QandR> list_chat_models;
    private Context context;
    private LayoutInflater layoutInflater;

    public CustomAdapter2(List<QandR> list_chat_models, Context context) {
...
//            if(list_chat_models.get(position).isSend==false)
...
//            else
            ...
            BubbleTextView text_message = (BubbleTextView)view.findViewById(R.id.text_message);
              text_message.setText(list_chat_models.get(position).getQuestionStr());
